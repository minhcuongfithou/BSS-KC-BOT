...
export default function CreateVahuPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`/api/vahu/${actionVahu}`, {
                method: 'PUT',
    ...
    return (
        <div className="container">
            <form onSubmit={handleSubmit}>
                <h1>Custom chỉ show một vài quốc gia ở Registration Form</h1>
                <p>
                    <strong>1. Hãy điền thông tin domain khách hàng</strong>
                </p>
                ...
                <p>
                    <strong>2. Chọn danh sách các quốc gia sẽ hiển thị</strong>
                </p>
